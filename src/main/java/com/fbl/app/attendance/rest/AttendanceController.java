...
public class AttendanceController {
    ...
    public void updateAttendanceRecordWorkers(@PathVariable int id, @RequestBody List<User> workers) {
        manageAttendanceService.assignWorkersToAttendanceRecord(id, workers);
    }
